...
from users.indexing.search_engines import indexed_search, sequential_search
...
class TestSearchEngines(SimpleTestCase):
    def test_sequential_search_filters_by_name(self):
        ...
        result = sequential_search(records, name_contains="Reló")
    ...
    def test_indexed_search_by_barcode(self):
        ...
        self.assertEqual(len(result), 1)
        self.assertEqual(result[0].item_id, 3)
